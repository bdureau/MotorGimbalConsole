...
import com.motorgimbalconsole.flights.FlightView.ChartView;
...
public class GimbalFcFlightFragment extends Fragment {
    ...
    public GimbalFcFlightFragment(ConsoleApplication bt) {
        lBT = bt;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_gimbal_telemetry_fc_tab0, container, false);
